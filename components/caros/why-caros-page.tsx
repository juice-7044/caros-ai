...
const categories = [
  ...
  { icon: Headphones, name: "Human Answering", items: ["Real people answer every call", "Qualified callers reach the right team", "After-hours coverage without voicemail"] },
