...
export default async function AffiliatesPage() {
  ...
  return <main>
    <AffiliateHero
      ...
      nodeLabels={{
        network: t("hero.visual.network"),
        owner: t("hero.visual.owner"),
        caros: t("hero.visual.caros"),
        revenue: t("hero.visual.revenue"),
      }}
      connector={t("hero.visual.connector")}
    />
    ...
    <section id="affiliate-application" className="scroll-mt-24 bg-card py-20"><div className="mx-auto max-w-[900px] px-6"><p className="eyebrow">{t("form.eyebrow")}</p><h2 className="mt-5 text-4xl font-extrabold">{t("form.title")}</h2><div className="mt-10"><AffiliateApplicationForm /></div></div></section>
  </main>
}
